...
window.onload = function () {
  ...
  console.log(str2);  // var 전연 변수
  console.log(this.str2); // var 전연 변수
  console.log(window.str2); // var 전연 변수
...
function typeTest() {
  ...
  // 함수
  let testFuction = function(num1, num2) {
    alert(num1 + num2);
  };
  ...
  // 따라사ㅓ 변수의 자료형을 확인하려면 typeof() 연산자를 사용해야 한다.
  ...
  area.innerHTML += `${testFuction}, ${typeof(testFuction)} <br>`;
}
...
function forInTest() {
  ...
  // 반복 변수에 array의 index를 순서대로 i에 달아서 반복시킨다.
